...
@section('content')
    ...
    <form  action="{{ route('negocio.categoria.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <img src="{{ asset('storage/images/categoriaProducto').'/'. $data->imagen }}" alt="Categoria del producto" width="150">
                        <br>
