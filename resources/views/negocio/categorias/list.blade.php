        ...
        <tbody>
            @foreach ($categoria_productos as $categoria)
                <tr class="body-table">
                    ...
                    <td >
                        <img class="img-responsive" src="{{ asset('storage/images/categoriaProducto').'/'. $categoria->imagen }}" width="100" height="80" alt="Imagen Categoría">
                    </td>
                    <td>
                    ...
                    <td>
                        <a type="button" href="{{ route('negocio.categoria.edit', $categoria->id) }}" class="btn btn-success" style="border-radius: 50%" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pen"></i></a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a type="button" class="btn btn-primary" href="{{ route('negocio.categoria.delete', $categoria->id) }}">Aceptar</a>
